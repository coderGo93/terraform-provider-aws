...
func TestAccAWSDataSourceTrafficPolicyDocument_basic(t *testing.T) {
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAWSTrafficPolicyDocumentDataSourceConfig,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsTrafficPolicySameJSON("data.aws_route53_traffic_policy_document.test",
						testAccAWSTrafficPolicyDocumentConfigExpectedJSON()),
				),
			},
		},
	})
...
func TestAccAWSDataSourceTrafficPolicyDocument_complete(t *testing.T) {
	resource.ParallelTest(t, resource.TestCase{
		PreCheck:          func() { testAccPreCheck(t) },
		ErrorCheck:        testAccErrorCheck(t, route53.EndpointsID),
		ProviderFactories: testAccProviderFactories,
		Steps: []resource.TestStep{
			{
				Config: testAccAWSTrafficPolicyDocumentDataSourceConfigComplete,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsTrafficPolicySameJSON("data.aws_route53_traffic_policy_document.test",
						testAccAWSTrafficPolicyDocumentConfigCompleteExpectedJSON()),
				),
			},
		},
	})
...
func testAccCheckAwsTrafficPolicySameJSON(resourceName, jsonExpected string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		var j, j2 Route53TrafficPolicyDoc
...
const testAccAWSTrafficPolicyDocumentDataSourceConfig = `
...
const testAccAWSTrafficPolicyDocumentDataSourceConfigComplete = `
...
func testAccAWSTrafficPolicyDocumentConfigExpectedJSON() string {
	return fmt.Sprintf(`{
...
func testAccAWSTrafficPolicyDocumentConfigCompleteExpectedJSON() string {
	return fmt.Sprintf(`{
  "AWSPolicyFormatVersion":"2015-10-01",
  "RecordType":"A",
...
}`, testAccGetRegion(), testAccGetAlternateRegion())
}
