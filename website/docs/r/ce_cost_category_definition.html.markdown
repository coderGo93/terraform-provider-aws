...
layout: "aws"
page_title: "AWS: aws_ce_cost_category_definition"
description: |-
  Provides a CostExplorer Cost Category Definition
---

# Resource: aws_ce_cost_category_definition

Provides an CostExplorer Cost Category Definition.
...
* `values` - (Optional) arameter values.
...
`aws_ce_cost_category_definition` can be imported using the id, e.g.

```
$ terraform import aws_ce_cost_category_definition.example costCategoryID
```
